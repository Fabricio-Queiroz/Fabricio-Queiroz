...
<p align="center">
  ...
  <a href="https://linkedin.com/in/fabricio-queiroz" target="_blank">
...
- 📍 Araçatuba – SP, Brasil
- 💡 Apaixonado por aprender na prática e construir soluções que ajudam pessoas no dia a dia
...
| [📊 Análise de Algoritmos de Ordenação](https://github.com/Fabricio-Queiroz/APS-Analise-Algoritmos) | Análise comparativa de performance de algoritmos (Bubble, Quick, Merge Sort) | Java |
| [🌊 Monitoramento Rio Tietê](https://github.com/Fabricio-Queiroz/monitoramento-tiete-aps) | Sistema de monitoramento ambiental com coleta e análise de dados | Java |
| [👥 Gestão de Funcionários JDBC](https://github.com/Fabricio-Queiroz/gestao-funcionario-jdbc) | CRUD completo de funcionários com persistência em banco de dados | Java · JDBC · SQL |
| [🧾 Automatizador de Holerites](https://github.com/Fabricio-Queiroz/automatizador-holerites) | App Windows que renomeia e une holerites em PDF — sem instalar nada | Python |
